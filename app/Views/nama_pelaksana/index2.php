...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Pelaksana</li>
          </ol>
    ...
    &nbsp;&nbsp;&nbsp;<a class="badge badge-sm bg-gradient-success" href="<?= site_url('/nama_pelaksana/create') ?>">Tambah Data</a>
    <table id="table1" class="table align-items-center mb-0">
        <thead>
            <tr>
                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Pelaksana</th>
                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">NIK / NIP</th>
        ...
        <?php foreach ($nama_pelaksanas as $nama_pelaksana) : ?>
            <tbody>
                  <tr>
                    ...
                    <td>
                        <a class="text-xs font-weight-bold mb-0" href="<?= site_url('/nama_pelaksana/edit/' . $nama_pelaksana['id']) ?>">Edit</a>
                        </br>
                        <a class="text-xs text-secondary mb-0" href="<?= site_url('/nama_pelaksana/delete/' . $nama_pelaksana['id']) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
                    </td>
                  </tr>
            </tbody>
    <?php endforeach; ?>
