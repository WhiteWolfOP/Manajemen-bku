...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
    ...
    &nbsp;&nbsp;&nbsp;<a class="badge badge-sm bg-gradient-success" href="<?= site_url('user/create') ?>">Tambah Data</a>
        ...
        <?php foreach ($users as $user) : ?>
            <tbody>
                  <tr>
                    ...
                    <td>
                        <a class="text-xs font-weight-bold mb-0" href="<?= site_url('user/edit/' . $user['id']) ?>">Edit</a>
                        </br>
                        <a class="text-xs text-secondary mb-0" href="<?= site_url('user/delete/' . $user['id']) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
                    </td>
                  </tr>
            </tbody>
    <?php endforeach; ?>
