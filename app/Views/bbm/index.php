   ...
   <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Kota</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">BBM</h6>
        </nav>
    ...
    <table id="table1" class="table align-items-center mb-0">
        <thead>
            <tr>
                ...
                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Harga BBM</th>
            ...
            <tbody>
                  <tr>
                    ...
                    <td>
                        <a class="text-xs font-weight-bold mb-0" href="<?= site_url('bbm/edit/' . $bbm['id']) ?>">Edit</a>
                        </br>
                        <a class="text-xs text-secondary mb-0" href="<?= site_url('bbm/delete/' . $bbm['id']) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
                    </td>
                  </tr>
            </tbody>
    <?php endforeach; ?>
