...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Perjalanan</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Dinas</h6>
        </nav>
    ...
    &nbsp;&nbsp;&nbsp;<a class="badge badge-sm bg-gradient-success" href="<?= site_url('/perjalanan_dinas/create') ?>">Tambah Data</a>
        ...
        <thead>
            ...
            <tbody>
                  <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                      <a href="" class="btn btn-primary">Upload Laporan <i class="material-icons opacity-10">edit</i></a>
